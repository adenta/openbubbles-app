...
class LaunchAtStartup {
  ...
  static setup(String appName, bool minimized) => las.LaunchAtStartup.instance.setup(
    appName: Platform.isLinux ? "openbubbles-dev" : appName,
    appPath: Platform.isLinux ? "/usr/bin/openbubbles-dev" : isFlatpak ? "flatpak run app.bluebubbles.BlueBubbles" : Platform.resolvedExecutable,
